                  ...
                  children: [
                    ...
                    ValueListenableBuilder<bool>(
                      ...
                      builder: (_, reduce, _) => _ToggleTile(
                        ...
                        subtitle: 'Use solid surfaces instead of live blur',
                        value: reduce,
                    ...
                    children: _loadingSettings
                        ...
                        : [
                            ...
                            _ToggleTile(
                              ...
                              subtitle:
                                  'Morning orders are placed for the next day',
                              value: advanceOn,
                              onChanged: (v) =>
                            ...
                            if (advanceOn)
                              _NavTile(
                                ...
                                subtitle:
                                    _settings['advance_window_start'] ??
                                    '06:00',
                                onTap: () => _editTime(
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.palette_rounded, color: palette.textSecondary),
                  const SizedBox(width: AppSpacing.md),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Accent theme', style: context.text.titleSmall),
                        const SizedBox(height: 2),
                        Text(
